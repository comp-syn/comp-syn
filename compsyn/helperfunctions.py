...
def get_webdriver(driver_browser: str, driver_executable_path: Optional[str], driver_options: Optional[List[str]] = None) -> webdriver:
    """
    ...
    try:
        ...
        raise Exception(f"no webdriver attribute called {driver_browser}, try setting browser to 'Chrome' or 'Firefox'") from e
...
def settings(application_cred_name: str, driver_browser: str, driver_executable_path: str, driver_options: Optional[List[str]] = None) -> None:
    ...
    wd = get_webdriver(driver_browser=driver_browser, driver_executable_path=driver_executable_path, driver_options=driver_options)
    wd.quit()
...
def fetch_image_urls(
    ...
    while image_count < number_of_links_to_fetch:
        ...
        log.info(f"Found: {number_results} search results. Extracting links from {results_start}:{number_results}")
...
def search_and_download(
    ...
    with get_webdriver(driver_browser=driver_browser, driver_executable_path=driver_executable_path, driver_options=driver_options) as wd:
